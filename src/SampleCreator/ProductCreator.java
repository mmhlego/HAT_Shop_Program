        ...
        public static void Create() {
                ...
                Product P1 = new Product("Samsung Galaxy A71",
                                ...
                                Product.ParseToArray(
                                                "[[حافظه داخلی : ,128 گیگابایت],[شبکه های ارتباطی : ,4G، 3G، 2G],[دوربین‌های پشت گوشی : ,4 ماژول دوربین],[سیستم عامل : ,Android]]"),
                                10299000, 20, Product.PHONE, 20, Product.GenerateID());
                ...
                Product P2 = new Product("iPhone 12 Pro Max",
                                ...
                                Product.ParseToArray(
                                                "[[حافظه داخلی : ,256 گیگابایت],[شبکه های ارتباطی : ,5G، 4G، 3G، 2G],[دوربین‌های پشت گوشی : ,4 ماژول دوربین],[سیستم عامل : ,iOS]]"),
                                39700000, 0, Product.PHONE, 20, Product.GenerateID());
                ...
                Product P3 = new Product("HUAWEI P40 Pro",
                                ...
                                Product.ParseToArray(
                                                "[[حافظه داخلی : ,256 گیگابایت],[شبکه های ارتباطی : ,5G، 4G، 3G، 2G],[دوربین‌های پشت گوشی : ,1 ماژول دوربین],[سیستم عامل : ,Android]]"),
                                23453000, 10, Product.PHONE, 20, Product.GenerateID());
                ...
                Product P4 = new Product("Samsung Galaxy Note20 Ultra",
                                ...
                                Product.ParseToArray(
                                                "[[حافظه داخلی : ,256 گیگابایت],[شبکه های ارتباطی : ,5G، 4G، 3G، 2G],[دوربین‌های پشت گوشی : ,4 ماژول دوربین],[سیستم عامل : ,Android]]"),
                                31599000, 5, Product.PHONE, 20, Product.GenerateID());
                ...
                Product P5 = new Product("Samsung Galaxy S21 Ultra",
                                ...
                                Product.ParseToArray(
                                                "[[حافظه داخلی : ,256 گیگابایت],[شبکه های ارتباطی : ,5G، 4G، 3G، 2G],[دوربین‌های پشت گوشی : ,4 ماژول دوربین],[سیستم عامل : ,Android]]"),
                                29000000, 0, Product.PHONE, 20, Product.GenerateID());
                ...
                Product P6 = new Product("iPhone 11",
                                ...
                                Product.ParseToArray(
                                                "[[حافظه داخلی : ,128 گیگابایت],[شبکه های ارتباطی : ,4G، 3G، 2G],[دوربین‌های پشت گوشی : ,2 ماژول دوربین],[سیستم عامل : ,iOS]]"),
                                24770000, 7, Product.PHONE, 20, Product.GenerateID());
                ...
                Product P7 = new Product("iPhone XS",
                                ...
                                Product.ParseToArray(
                                                "[[حافظه داخلی : ,256 گیگابایت],[شبکه های ارتباطی : ,4G، 3G، 2G],[دوربین‌های پشت گوشی : ,2 ماژول دوربین],[سیستم عامل : ,iOS]]"),
                                30000000, 25, Product.PHONE, 20, Product.GenerateID());
                ...
                Product P8 = new Product("Samsung Galaxy A51",
                                ...
                                Product.ParseToArray(
                                                "[[حافظه داخلی : ,256 گیگابایت],[شبکه های ارتباطی : ,4G، 3G، 2G],[دوربین‌های پشت گوشی : ,4 ماژول دوربین],[سیستم عامل : ,Android]]"),
                                8999000, 4, Product.PHONE, 20, Product.GenerateID());
                ...
                Product P9 = new Product("Samsung Galaxy M51",
                                ...
                                Product.ParseToArray(
                                                "[[حافظه داخلی : ,128 گیگابایت],[شبکه های ارتباطی : ,4G، 3G، 2G],[دوربین‌های پشت گوشی : ,4 ماژول دوربین],[سیستم عامل : ,Android]]"),
                                9749000, 0, Product.PHONE, 20, Product.GenerateID());
                ...
                Product P10 = new Product("Samsung Galaxy A52",
                                ...
                                Product.ParseToArray(
                                                "[[حافظه داخلی : ,256 گیگابایت],[شبکه های ارتباطی : ,4G، 3G، 2G],[دوربین‌های پشت گوشی : ,4 ماژول دوربین],[سیستم عامل : ,Android]]"),
                                9599000, 10, Product.PHONE, 20, Product.GenerateID());
                ...
                Product P11 = new Product("ASUS Zenbook UX431FL",
                                ...
                                29100000, 1, Product.COMPUTER, 20, Product.GenerateID());
                ...
                Product P12 = new Product("ASUS ZenBook UX534FTC",
                                ...
                                49000000, 5, Product.COMPUTER, 20, Product.GenerateID());
                ...
                Product P13 = new Product("Microsoft Surface Book 3F",
                                ...
                                99999000, 8, Product.COMPUTER, 20, Product.GenerateID());
                ...
                Product P14 = new Product("ASUS ROG M15",
                                ...
                                Product.ParseToArray(
                                                "[[ظرفیت حافظه RAM : ,16 گیگابایت],[ظرفیت حافظه داخلی : ,  یک ترابایت],[[سازنده پردازنده گرافیکی : ,NVIDIA],[اندازه صفحه نمایش : ,15.6 اینچ]]"),
                                60499000, 9, Product.COMPUTER, 20, Product.GenerateID());
                ...
                Product P15 = new Product("Lenovo ThinkPad T490S",
                                ...
                                65000000, 0, Product.COMPUTER, 20, Product.GenerateID());
                ...
                Product P16 = new Product("ASUS Zbook 15 G5",
                                ...
                                61790000, 11, Product.COMPUTER, 20, Product.GenerateID());
                ...
                Product P17 = new Product("HP OMEN 17",
                                ...
                                59730000, 7, Product.COMPUTER, 20, Product.GenerateID());
                ...
                Product P18 = new Product("Desktop Green Z6 Artemis",
                                ...
                                222222000, 0, Product.COMPUTER, 20, Product.GenerateID());
                ...
                Product P19 = new Product("MacBook Pro MVVK2",
                                ...
                                75964000, 28, Product.COMPUTER, 20, Product.GenerateID());
                ...
                Product P20 = new Product("ACER Nitro 5",
                                ...
                                36250000, 12, Product.COMPUTER, 20, Product.GenerateID());
                ...
                Product P21 = new Product(" Apple Watch Milanese Loop",
                                ...
                                27499000, 1, Product.ACCESSORIES, 20, Product.GenerateID());
                ...
                Product P22 = new Product("Gaming Set",
                                ...
                                14000000, 50, Product.ACCESSORIES, 20, Product.GenerateID());
                ...
                Product P23 = new Product("Hard External",
                                ...
                                109500000, 25, Product.ACCESSORIES, 20, Product.GenerateID());
                ...
                Product P24 = new Product("Printer LaserJet Enterprise",
                                ...
                                123060000, 8, Product.ACCESSORIES, 20, Product.GenerateID());
                ...
                Product P25 = new Product("PlayStation 5",
                                ...
                                Product.ParseToArray("[[تعداد دسته : ,2],[بازی : ,ندارد]]"), 34700730, 0,
                                Product.ACCESSORIES, 20, Product.GenerateID());

                Product P26 = new Product("Laptop Bag", "کیف محکم و مقاوم برای لپ تاپ",
                                Product.ParseToArray("[[مناسب برای لپ تاپ های : ,15 تا 17 اینچی]]"), 5000000, 0,
                                Product.ACCESSORIES, 20, Product.GenerateID());
                ...
                Product P27 = new Product("ROG Strix Cooler",
                                ...
                                7980000, 2, Product.ACCESSORIES, 20, Product.GenerateID());
                ...
                Product P28 = new Product("Graphics Card TUF",
                                ...
                                100000000, 9, Product.ACCESSORIES, 20, Product.GenerateID());
                ...
                Product P29 = new Product("Philips Monitor",
                                ...
                                21200000, 0, Product.ACCESSORIES, 20, Product.GenerateID());
                ...
                Product P30 = new Product("Nimbus Wireless Game Controller",
                                ...
                                Product.ParseToArray("[[نوع اتصال : ,بی‌سیم],[رابط : ,بلوتوث]"), 3990000, 5,
                                Product.ACCESSORIES, 20, Product.GenerateID());

                Product P31 = new Product("Milk", "شیر کم چرب میهن",
                                Product.ParseToArray("[[طعم : ,ساده],[مناسب برای : ,خانواده]]"), 12600, 0,
                                Product.SUPERMARKET, 20, Product.GenerateID());
                ...
                Product P33 = new Product("Frozen fillele", "فيله منجمد سی بس ايناس", Product.ParseToArray("[]"),
                                148500, 0, Product.SUPERMARKET, 20, Product.GenerateID());

                Product P34 = new Product("Cucumber", "خیار میوری", Product.ParseToArray("[[ارگانیک : ,خیر]]"), 9900, 0,
                                Product.SUPERMARKET, 20, Product.GenerateID());

                Product P35 = new Product("Onion", "پياز سفيد ميوري", Product.ParseToArray("[]"), 11000, 0,
                                Product.SUPERMARKET, 20, Product.GenerateID());
                ...
                Product P38 = new Product("Macaroni", "ماکارونی پیکولی زر ماکارون",
                                Product.ParseToArray("[[فرم : ,پیچی],[ارگانیک : ,خیر]]"), 6600, 0, Product.SUPERMARKET,
                                20, Product.GenerateID());

                Product P39 = new Product("Whipped Cream", "پودر خامه کیک و شیرینی پزی کاکائویی",
                                Product.ParseToArray("[[تراریخته : ,خیر]]"), 22100, 0, Product.SUPERMARKET, 20,
                                Product.GenerateID());

                Product P40 = new Product("Tomato Paste", "رب گوجه فرنگی بیژن",
                                Product.ParseToArray("[[محدوده وزن : ,بیشتر از 500 گرم],[در آسان باز شو : ,دارد]]"),
                                15400, 0, Product.SUPERMARKET, 20, Product.GenerateID());

                Product P41 = new Product("Learn Python", "نرم افزار آموزش شرکت پرند",
                                Product.ParseToArray("[[نوع دیسک : DVD9],[تعداد دیسک : ,2]]"), 110000, 10, Product.BOOK,
                                20, Product.GenerateID());

                Product P42 = new Product("Learn HTML,CSS", "نرم افزار آموزش شرکت پرند",
                                Product.ParseToArray("[[نوع دیسک : ,DVD9],[تعداد دیسک : ,2]]"), 110000, 7, Product.BOOK,
                                20, Product.GenerateID());

                Product P43 = new Product("Learn C++", "نرم افزار آموزش شرکت پرند",
                                Product.ParseToArray("[[نوع دیسک : ,DVD9],[تعداد دیسک : ,2]]"), 96000, 9, Product.BOOK,
                                20, Product.GenerateID());

                Product P44 = new Product("Learn Android", "نرم افزار آموزش شرکت پرند",
                                Product.ParseToArray("[[نوع دیسک : ,DVD9],[تعداد دیسک : ,2]]"), 96000, 10, Product.BOOK,
                                20, Product.GenerateID());

                Product P45 = new Product("Learn Java", "نرم افزار آموزش شرکت پرند",
                                Product.ParseToArray("[[نوع دیسک : ,DVD9],[تعداد دیسک : ,2]]"), 96000, 0, Product.BOOK,
                                20, Product.GenerateID());

                Product P46 = new Product("Learn PHP", "نرم افزار آموزش شرکت پرند",
                                Product.ParseToArray("[[نوع دیسک : ,DVD9],[تعداد دیسک : ,2]]"), 96000, 5, Product.BOOK,
                                20, Product.GenerateID());

                Product P47 = new Product("Learn Visual C#", "نرم افزار آموزش شرکت پرند",
                                Product.ParseToArray("[[نوع دیسک : ,DVD9],[تعداد دیسک : ,2]]"), 110000, 30,
                                Product.BOOK, 20, Product.GenerateID());

                Product P48 = new Product("IELTS English", "نرم افزار آموزش زبان انگلیسی نشر درنا",
                                Product.ParseToArray("[[نوع دیسک : ,DVD],[تعداد دیسک : ,4]]"), 115000, 49, Product.BOOK,
                                20, Product.GenerateID());

                Product P49 = new Product("Nosrat English", "بسته آموزش سریع مکالمه زبان انگلیسی نصرت نشر نصرت",
                                Product.ParseToArray("[[نوع دیسک : ,DVD],[تعداد دیسک : ,1]]"), 52500, 0, Product.BOOK,
                                20, Product.GenerateID());

                Product P50 = new Product("Rosseta Stone", "آموزش زبان انگلیسی رزتااستون جامع نشر نیاز",
                                Product.ParseToArray("[[نوع دیسک : ,DVD],[تعداد دیسک : ,2]]"), 230000, 0, Product.BOOK,
                                20, Product.GenerateID());
